...
import com.example.payment.service.refund.RefundServiceRequest
import com.example.payment.service.refund.RefundServiceResponse
    ...
    companion object {
        ...
        fun from(refundServiceResponse: RefundServiceResponse) =
            RefundResponse(
                ...
                refundAt = refundServiceResponse.refundAt
            )
    }
}
